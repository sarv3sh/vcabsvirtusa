...
<title>DRIVER INFO</title>
 <script src="https://www.gstatic.com/firebasejs/7.4.0/firebase.js"></script>
	...
	<link href="passenger.html" rel="stylesheet">
...
<h1 style="text-align: center; padding-top: 30px;font-family: 'Raleway', sans-serif;margin-top: 0px; height: 100px; margin-bottom:0px;" ><strong>DRIVER DETAILS</strong></h1>
</div>
...
<table class="table table-striped table-dark">
  <thead>
    <tr>
      ...
      <th scope="col">driving lic number</th>
      ...
      <%
		...
		try{
			...
			while(rs.next())
			{
				...
				<td><%=rs.getString("adhaarnu") %></td>
				<td><%=rs.getString("drivinglicnu") %></td>
